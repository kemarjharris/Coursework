...
app.post('/signup/',
    ...
    if (!validator.isAlphanumeric(username)) return res.status(400).end("bad input");
    if (!validator.isAlphanumeric(password)) return res.status(400).end("bad input");
...
app.post('/api/messages/',
    ...
    var message = new Message(validator.escape(req.body.content), req.session.username);
